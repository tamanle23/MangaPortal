...
using MangaPortal.Attributes;
using MangaPortal.Filters;
using MangaPortal.Models;
...
namespace MangaPortal.Controllers
{
    ...
    public class MangaController : System.Web.Http.ApiController
    {
        ...
        private static MangaDataContext MangaDataContext;
        ...
        public object GetPartDirectly(int part, int number, string site)
        {
            ...
            {
                Logger.Write(LogLevel.Error, "Error", ex);
            }
            return result;
        }
        ...
        public object FullTextSearch(string keywords)
        {
            ...
            using (var context = ServiceLocator.Current.GetInstance<MangaDataContext>())
            {
                ...
                var results = context
                    .ObjContext()
                    .ExecuteStoreQuery<int>(String.Format("Select top 20 Id from MangaSeries where FREETEXT(FullText,'{0}')", keywords));
                if (results != null)
                {
        ...
        [HttpGet]
        [ApiCache(10 * 60 * 1000, 60 *1000, false)]
        ...
        [HttpGet]
        [ApiCache(1000 * 1000, 1000 * 1000, false)]
        ...
        [HttpGet]
        [ApiCache(300 *1000, 60 *1000, false)]
        ...
        [HttpGet]
        [ApiCache(400 *1000, 2000 *1000, false)]
