(function ()
{
    ...
    var HomeViewModel = function ()
    {
        ...
        self.OpenSeriesInfo = function (data, event, selectedItem)
        {
            ...
            $.ajax({
                ...
                error: function (e)
                {
                    alert('Không tìm thấy thông tin truyện.');
                },
                complete: function (data)
                {
                    $("#BusyIndicator").hide();
            ...
            $.ajax({
                ...
                success: function (data)
                {
                    if (data)
                    {
                        ...
                        if (data.length == 0)
                        {
                            self.SearchTextResult("Không tìm thấy.");
                        } else
                            self.SearchTextResult("Tìm thấy " + data.length + " truyện.");
                    }
                },
                error: function (e)
                {
        ...
        self.NextChapter = function ()
        {
            ...
            {
                alert("Hiện tại bạn đã xem tập mới nhất của bộ truyện!!! \nTập tiếp theo sẽ được chúng tôi cập nhật trong thời gian sớm nhất có thể.");
            }
        };
    ...
    //window.apiUrl =  "http://192.168.33.51/";
